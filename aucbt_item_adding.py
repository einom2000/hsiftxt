...
while True:
    ...
    print('please press SPACE to input!')
    print('X --- to exit')
    print('9 --- set all goods overlooked with 9#')
    print('2 --- set all goods just recorded with 2# on daytime')
    print('0 --- to snip all the goods at 80% lowest_average')
    print('1 --- to keep current on shelf and change others to 0#')
    print('8 --- a temp command')
    print('d --- to delete a good from goods list')

    while True:
        if keyboard.is_pressed('x'):
            sys.exit()
        elif keyboard.is_pressed('9'):
            modify(9, True)   # is number one gets changed?
            sys.exit()
